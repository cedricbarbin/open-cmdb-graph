...
const CMDB_REL_TYPES = [
  ...
  'OWNS_DATA', 'CONSUMES_DATA', 'CLASSIFIED_AS', 'STORED_ON', 'IMPLEMENTS',
  'HAS_FUNCTION', 'HAS_MENU', 'HAS_FORM', 'HAS_REPORT', 'HAS_EXPORT',
  'HAS_ENDPOINT', 'HAS_SETTING_FILE', 'HAS_ALGORITHM', 'SOURCE_REPOSITORY',
  'CONTAINS_FILE', 'REALIZED_BY', 'DEFINED_IN', 'OF_TYPE', 'IN_BUSINESS_DOMAIN',
  'ALIAS_OF'
];
